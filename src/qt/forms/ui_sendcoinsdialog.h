...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 69C"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 69C"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 69C"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 69C"));
        ...
        labelBalance->setText(QString::fromUtf8("123.456 69C"));
...
#endif // QT_NO_TOOLTIP
        labelCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for kh69coin transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for kh69coin transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
