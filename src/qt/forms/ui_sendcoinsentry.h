...
public:
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The kh69coin address to send the payment to", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less kh69coins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        useAvailableBalanceButton->setText(QApplication::translate("SendCoinsEntry", "Use available balance", 0, QApplication::UnicodeUTF8));
        messageLabel->setText(QApplication::translate("SendCoinsEntry", "Message:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the kh69coin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the kh69coin network.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
